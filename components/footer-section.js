        ...
        <div className="row">
          <div className="col-xl-3 col-lg-4 col-md-6 col-sm-10">
            <div className="footer-widget">
              ...
              <p className="desc">Built better with Butter.</p>
              <ul className="social-links">
                <li>
                  <a href="https://www.facebook.com/manas1104">
                    <i className="lni lni-facebook"></i>
                  </a>
                </li>
                <li>
                  <a href="https://linkedin.com/in/manas-mallick-77781431/">
                    <i className="lni lni-linkedin"></i>
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/i_m_manass/">
                    <i className="lni lni-instagram"></i>
                  </a>
                </li>
                <li>
                  <a href="https://twitter.com/is_manas">
